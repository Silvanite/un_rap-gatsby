...
const Believe = () => {
  ...
  const Wrapper = tw.div`my-8 px-8 py-16 text-3xl text-gray-700 leading-none font-display bg-orange-100 md:mt-0 w-full`
  const Container = tw.div`max-w-xl mx-auto md:px-8 md:text-center`
  const Message = tw.span`font-bold text-orange-500 block md:inline md:pl-2 w-full`
